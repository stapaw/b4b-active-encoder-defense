...
def load_weights_dino(model, weights_dino, checkpoint_key, model_name, patch_size):
    if os.path.isfile(weights_dino):
        state_dict = torch.load(weights_dino, map_location="cpu")
        ...
        print(
            "Please use the `--weights_dino` argument to indicate the path of the checkpoint to evaluate."
        )
        url = None
